      ...
      <div class="container">
         <div class="row">
            <div class="col-6 col-sm-6 col-md-2 py-1">
               <a href="http://localhost/ThanhThuc_2121110112_WED/">
                  <img src="public/images/c1.png" class="img-fluid" alt="Logo">
               </a>
            </div>
            ...
            <div class="col-12 col-sm-12 d-none d-md-block col-md-4 text-center py-2">
                     ...
                     <?php if (isset($_SESSION['iscustom'])) : ?>
                        ...
                        <li class="nav-item">
                           <a class="nav-link" href="index.php?option=profile">
                              Tên khách hàng: <?php echo $_SESSION['iscustom']; ?>
                           </a>
                        </li>
                        <li class="nav-item">
               ...
               <div class="fs-6 py-2">
                  ĐỔI TRẢ HÀNG HOẶC HOÀN TIỀN <span class="text-main"></span>
               </div>
            </div>
